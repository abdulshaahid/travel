...
export const TravelCard = ({ package: pkg }: TravelCardProps) => {
  return (
    <div className="relative group">
      <div className="w-full rounded-2xl overflow-hidden bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl 
        ...
        <div className="p-4">
          <div className="flex justify-between items-center mb-2">
            <div className="flex items-center gap-1">
              ...
              <span className="text-sm font-medium dark:text-white">{pkg.rating}</span>
            </div>
            <div className="flex items-center gap-1">
          ...
          <div className="flex justify-between items-center">
            <p className="text-blue-600 dark:text-blue-400 font-bold">${pkg.price}</p>
